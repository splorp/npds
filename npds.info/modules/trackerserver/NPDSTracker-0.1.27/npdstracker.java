...
// last modified 2001 August 18th

// CHANGELOG (version numbers are defined as major.minor.build)
// 0.1.27 [VR] Now saves registered server information for automatic reloading upon a crash or restart
...
public class npdstracker extends Thread
{
	...
	public static void saveServers()
	{
		...
		try {
                ...
                outcmdfile.flush();
                outcmdfile.close();
		} catch (IOException e) {System.out.println("-> FATAL - can't write to logfile: " + cmdfile);}
		}
	}
}
